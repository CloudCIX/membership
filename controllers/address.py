...
class AddressListController(ControllerBase):
    ...
    class Meta(ControllerBase.Meta):
        ...
        search_fields = {
            ...
            'address_link__cloud_customer': (),
            'address_link__cloud_export_markup': ControllerBase.DEFAULT_NUMBER_FILTER_OPERATORS,
            'address_link__cloud_import_markup': ControllerBase.DEFAULT_NUMBER_FILTER_OPERATORS,
            'address_link__cloud_seller': (),
            'address_link__cloud_seller_markup': ControllerBase.DEFAULT_NUMBER_FILTER_OPERATORS,
