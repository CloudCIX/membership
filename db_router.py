...
class MembershipRouter:
    """
    This class controls Django's DB functionality to ensure that all
    membership models get routed to the membership DB
    """
    ...
    def db_for_read(self, model: Type[Model], **hints: Dict[str, Any]) -> Optional[str]:
        ...
        """
        if model._meta.app_label == 'membership':
            return 'membership'
    ...
    def allow_relation(self, model1: Type[Model], model2: Type[Model], **hints: Dict[str, Any]) -> Optional[bool]:
        ...
        """
        return True if model1._meta.app_label == 'membership' and model2._meta.app_label == 'membership' else None
    ...
    def allow_migrate(self, db: str, app_label: str, model_name: str = None, **hints: Dict[str, Any]) -> Optional[bool]:
        ...
        """
        return True if app_label == 'membership' and db == 'membership' else None
