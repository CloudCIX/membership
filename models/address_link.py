...
class AddressLink(BaseModel):
    ...
    cloud_builder = models.BooleanField(default=False)
    cloud_customer = models.BooleanField(default=False)
    cloud_distributor = models.BooleanField(default=False)
    cloud_export_markup = models.DecimalField(max_digits=24, decimal_places=4, default='0.0000')
    cloud_import_markup = models.DecimalField(max_digits=24, decimal_places=4, default='0.0000')
    cloud_seller = models.BooleanField(default=False)
    cloud_seller_markup = models.DecimalField(max_digits=24, decimal_places=4, default='0.0000')
    ...
    extra_reference1 = models.TextField(null=True)
    extra_reference2 = models.TextField(null=True)
    extra_reference3 = models.TextField(null=True)
